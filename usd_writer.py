...
(
    ...
    metersPerUnit = 1.0
    upAxis = "Z"
    doc = "Sample battery module: 2x3 LG E63 prismatic cells with UR10e robot"
)
...
def Xform "World"
{
    ...
    def Cube "Cell_03"
    {
        ...
        custom string battery:cellType = "HY_50Ah"
    ...
    def Cube "Cell_06"
    {
        ...
        custom string battery:cellType = "CATL_LFP"
    ...
    {
        float3 xformOp:translate = (0.0, 0.0, 1.5)
        uniform token[] xformOpOrder = ["xformOp:translate"]
